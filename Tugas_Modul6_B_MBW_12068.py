...
model = load_model(r'C:\Users\Lenovo\Downloads\Tugas6_B_12068\gugelnet.h5')
...
def classify_image(image_path):
    try:
        ...
        input_image_expt_dim = tf.expand_dims(input_image_array, 0)

        predictions = model.predict(input_image_expt_dim)
...
st.title("Prediksi Kematangan Buah Naga - 2068")
